...
urlpatterns = [
    ...
    url(r'^cost_compariosn_summary$', views.cost_compariosn_summary, name='cost_compariosn_summary'),
    ...
    url(r'^pr_code_summary_proc_dropdowns$', views.pr_code_summary_proc_dropdowns, name='pr_code_summary_proc_dropdowns'),
