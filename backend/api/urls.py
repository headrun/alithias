...
urlpatterns = [
    ...
    url(r'^proc_episode_get_city/', views.proc_episode_get_city, name='proc_episode_get_city'),
    url(r'^proce_episode_get_provider/', views.proce_episode_get_provider, name='proce_episode_get_provider'),
